...
import {
  ...
  Button, Banner, DataTable, Badge, Select, TextField,
  Modal, Checkbox, Popover, ActionList, Box, Pagination,
  Tabs, EmptyState, Spinner
...
export default function ProductionQueuePage() {
  ...
  const [selectedUploadForStatus, setSelectedUploadForStatus] = useState<typeof uploads[0] | null>(null);
  const [newStatus, setNewStatus] = useState("");
  const [notes, setNotes] = useState("");

  // Tab counts
  const totalCount = Object.values(statusCounts as Record<string, number>).reduce((a, b) => a + b, 0);
  const tabs = [
    { id: "all", content: `All (${totalCount})`, panelID: "all" },
    { id: "needs_review", content: `Needs Review (${(statusCounts as Record<string, number>).needs_review || 0})`, panelID: "needs_review" },
    { id: "approved", content: `Approved (${(statusCounts as Record<string, number>).approved || 0})`, panelID: "approved" },
    { id: "printing", content: `Printing (${(statusCounts as Record<string, number>).printing || 0})`, panelID: "printing" },
    { id: "shipped", content: `Shipped (${(statusCounts as Record<string, number>).shipped || 0})`, panelID: "shipped" },
  ];
  ...
  const rows = uploads.map((upload: any) => [
    ...
    upload.orderId ? (
      <Text as="span" variant="bodySm">#{upload.orderId.slice(-6)}</Text>
    ) : (
      <Text as="span" tone="subdued">—</Text>
    ),
                            ...
                            items={[
                              {
                                ...
                                onAction: () => {
                                  ...
                                  (form.querySelector('[name="status"]') as HTMLInputElement).value = "approved";
                                  form.submit();
                                },
                              },
                              {
                                ...
                                onAction: () => {
                                  const form = document.getElementById("bulk-form") as HTMLFormElement;
                                  (form.querySelector('[name="status"]') as HTMLInputElement).value = "printing";
                                  form.submit();
                                },
                              },
                              {
                                ...
                                onAction: () => {
                                  const form = document.getElementById("bulk-form") as HTMLFormElement;
                                  (form.querySelector('[name="status"]') as HTMLInputElement).value = "printed";
                                  form.submit();
                                },
                              },
                              {
                                ...
                                onAction: () => {
                                  const form = document.getElementById("bulk-form") as HTMLFormElement;
                                  (form.querySelector('[name="status"]') as HTMLInputElement).value = "shipped";
                                  form.submit();
                                },
                              },
                              {
                                ...
                                onAction: () => {
                                  const form = document.getElementById("bulk-form") as HTMLFormElement;
                                  (form.querySelector('[name="status"]') as HTMLInputElement).value = "rejected";
                                  form.submit();
                                },
                              },
                              {
