          ...
          <Card>
            <BlockStack gap="400">
              ...
              <BlockStack gap="300">
                ...
                <Text as="p">Product 3D Customizer &amp; Upload is a Shopify application that provides:</Text>
                <List type="bullet">
              ...
              <BlockStack gap="300">
                ...
                <Text as="p">
                  ...
                  <Link url="mailto:legal@customizerapp.dev">legal@customizerapp.dev</Link>
                </Text>
              </BlockStack>
            </BlockStack>
          </Card>
