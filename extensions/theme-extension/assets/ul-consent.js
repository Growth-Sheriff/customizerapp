...
(function() {
  ...
  const DEFAULT_CONFIG = {
    ...
    text: {
      ...
      message: 'We use cookies and similar technologies to improve your experience, analyze traffic, and personalize content. By clicking "Accept", you consent to our use of these technologies.',
      acceptButton: 'Accept',
  ...
  const ULConsent = {
    ...
    hideBanner() {
      ...
      this.bannerElement.style.transform = this.config.position === 'bottom' 
        ? 'translateY(100%)' 
        : 'translateY(-100%)';
